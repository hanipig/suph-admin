  ...
  <div class="tabs-bar">
    ...
    <div class="tabs-outer" ref="scrollOuter" @DOMMouseScroll="handlescroll" @mousewheel="handlescroll">
      <ul class="tabs-inner" ref="scrollBody" :style="{left: tagBodyLeft + 'px'}">
        <li v-for="item in tagNavList" :key="item.name" @click="handleSelect(item)" :data-router="JSON.stringify(item)">
...
export default {
  ...
  methods: {
    ...
    moveToView () {
      console.log(this.$refs.scrollOuter)
      console.log()
